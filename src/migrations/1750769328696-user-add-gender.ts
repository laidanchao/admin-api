...
export class UserAddGender1750769328696 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(
      `ALTER TABLE "sys_menu" ADD CONSTRAINT "FK_7cef4adcf9b01b2c6f14d52b0f3" FOREIGN KEY ("parent_id") REFERENCES "sys_menu"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "sys_menu" DROP CONSTRAINT "FK_7cef4adcf9b01b2c6f14d52b0f3"`,
    );
