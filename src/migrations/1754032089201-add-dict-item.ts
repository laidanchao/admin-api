...
export class AddDictItem1754032089201 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sys_dict" ADD "desc" character varying(255)`);
        await queryRunner.query(`COMMENT ON COLUMN "sys_dict"."desc" IS '字典描述'`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`COMMENT ON COLUMN "sys_dict"."desc" IS '字典描述'`);
        await queryRunner.query(`ALTER TABLE "sys_dict" DROP COLUMN "desc"`);
        await queryRunner.query(`ALTER TABLE "sys_dict" ADD "description" character varying(255)`);
        await queryRunner.query(`ALTER TABLE "sys_dict" ADD "type" character varying(50)`);
